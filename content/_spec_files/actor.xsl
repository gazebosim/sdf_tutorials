...
<xsl:template match="/element[@name='sdf']/element[@name='world']/element[@name='actor'] | /element[@name='sdf']/element[@name='world']/element[@name='actor']//*">
  <xsl:if test="@name='actor'">
  <p>
    <b>Parent element: </b>&lt;sdf&gt; or &lt;world&gt;<br/>
    <b>Notes:</b> An SDFormat file can consist of just an actor. A world can contain many actors.
  </p>
  </xsl:if>
  ...
  <li>
    ...
    <a href="/spec/__VERSION__/actor#{../@name}_{@name}">
...
<xsl:template match="/element[@name='sdf']/element[@name='world']/element[@name='actor']//attribute">
  <li>
    <a name="{../@name}_{@name}"></a>
    <a href="/spec/__VERSION__/actor#{../@name}_{@name}">
...
<xsl:template match="/element[@name='sdf']/element[@name='world']/element[@name='actor']/element[@name='link']">
  <li>
...
<xsl:template match="/element[@name='sdf']/element[@name='world']/element[@name='actor']/element[@name='joint']">
  <li>
