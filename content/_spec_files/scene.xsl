...
<xsl:template match="element[@name='sdf']/element[@name='world']/element[@name='scene'] | element[@name='sdf']/element[@name='world']/element[@name='scene']//*">
  <xsl:if test="@name='scene'">
  <p>
    <b>Parent element: </b>&lt;world&gt;<br/>
    <b>Notes:</b> A world can have only one scene.
  </p>
  </xsl:if>
  ...
  <li>
    ...
    <a href="/spec/__VERSION__/scene#{../@name}_{@name}">
    <span class="tree-element" style="width: 600px">
...
<xsl:template match="element[@name='sdf']/element[@name='world']/element[@name='scene']//attribute">
  <li>
    <a name="{../@name}_{@name}"></a>
    <a href="/spec/__VERSION__/scene#{../@name}_{@name}">
    <span class="tree-attribute" style="width: 600px">
