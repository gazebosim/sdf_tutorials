...
<xsl:template match="/element[@name='sdf']/element[@name='world']/element[@name='model'] | /element[@name='sdf']/element[@name='world']/element[@name='model']//*">
  <xsl:if test="(@name='model') and (../@name='world')">
  <p>
    <b>Parent element: </b>&lt;sdf&gt; or &lt;world&gt;<br/>
    <b>Notes:</b> An SDFormat file can consist of just a model. A world can contain many models.
  </p>
  </xsl:if>
  ...
  <li>
    ...
    <a href="/spec/__VERSION__/model#{../@name}_{@name}">
...
<xsl:template match="/element[@name='sdf']/element[@name='world']/element[@name='model']//attribute">
  <li>
    <a name="{../@name}_{@name}"></a>
    <a href="/spec/__VERSION__/model#{../@name}_{@name}">
...
<xsl:template match="/element[@name='sdf']/element[@name='world']/element[@name='model']/element[@name='link']">
  <li>
    <a href="/spec/__VERSION__/link" class="other-tab">
...
<xsl:template match="/element[@name='sdf']/element[@name='world']/element[@name='model']/element[@name='joint']">
  <li>
