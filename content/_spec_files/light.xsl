...
<xsl:template match="element[@name='sdf']/element[@name='world']/element[@name='light'] | element[@name='sdf']/element[@name='world']/element[@name='light']//*">
  <xsl:if test="@name='light'">
  <p>
    <b>Parent element: </b>&lt;world&gt; or &lt;link&gt;<br/>
    <b>Notes:</b> A world and link may have many lights.
  </p>
  </xsl:if>
  ...
  <li>
    ...
    <a href="/spec/__VERSION__/light#{../@name}_{@name}">
...
<xsl:template match="element[@name='sdf']/element[@name='world']/element[@name='light']//attribute">
  <li>
    <a name="{../@name}_{@name}"></a>
    <a href="/spec/__VERSION__/light#{../@name}_{@name}">
