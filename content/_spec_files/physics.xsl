...
<xsl:template match="element[@name='sdf']/element[@name='world']/element[@name='physics'] | element[@name='sdf']/element[@name='world']/element[@name='physics']//*">
  <xsl:if test="@name='physics'">
  <p>
    <b>Parent element: </b>&lt;world&gt;<br/>
    <b>Notes:</b> A world can have only one physics element.
  </p>
  </xsl:if>
  ...
  <li>
    ...
    <a href="/spec/__VERSION__/physics#{../@name}_{@name}">
...
<xsl:template match="element[@name='sdf']/element[@name='world']/element[@name='physics']//attribute">
  <li>
    <a name="{../@name}_{@name}"></a>
    <a href="/spec/__VERSION__/physics#{../@name}_{@name}">
