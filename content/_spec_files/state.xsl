...
<xsl:template match="/element[@name='sdf']/element[@name='world']/element[@name='state'] | /element[@name='sdf']/element[@name='world']/element[@name='state']//*">
  <xsl:if test="@name='state'">
  <p>
    <b>Parent element: </b>&lt;world&gt;<br/>
    <b>Notes:</b> A world can have only one state element.
  </p>
  </xsl:if>
  ...
  <li>
    ...
    <a href="/spec/__VERSION__/state#{../@name}_{@name}">
...
<xsl:template match="element[@name='sdf']/element[@name='world']/element[@name='state']//attribute">
  <li>
    <a name="{../@name}_{@name}"></a>
    <a href="/spec/__VERSION__/state#{../@name}_{@name}">
...
<xsl:template match="/element[@name='sdf']/element[@name='world']/element[@name='state']/element[@name='insertions']/element[@name='model']">
  <li>
