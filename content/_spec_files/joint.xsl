...
<xsl:template match="/element[@name='sdf']/element[@name='world']/element[@name='model']/element[@name='joint'] | /element[@name='sdf']/element[@name='world']/element[@name='model']/element[@name='joint']//*">

  <xsl:if test="@name='joint'">
  <p>
    <b>Parent element: </b>&lt;model&gt;<br/>
    <b>Notes:</b> A model may contain many joints.
  </p>
  </xsl:if>
  ...
  <li>
    ...
    <a href="/spec/__VERSION__/joint#{../@name}_{@name}">
...
<xsl:template match="/element[@name='sdf']/element[@name='world']/element[@name='model']/element[@name='joint']//attribute">
  <li>
    <a name="{../@name}_{@name}"></a>
    <a href="/spec/__VERSION__/joint#{../@name}_{@name}">
...
<xsl:template match="/element[@name='sdf']/element[@name='world']/element[@name='model']/element[@name='joint']/element[@name='sensor']">
  <li>
